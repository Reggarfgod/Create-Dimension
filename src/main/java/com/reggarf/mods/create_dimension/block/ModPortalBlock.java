...
import com.reggarf.mods.create_dimension.worldgen.teleporter.ModPortalShape;
import com.reggarf.mods.create_dimension.worldgen.teleporter.ModTeleporter;
...
public class ModPortalBlock extends NetherPortalBlock {
	...
	private ModTeleporter getTeleporter(ServerLevel level) {
		return new ModTeleporter(level);
	}
	...
	private static DimensionTransition createDimensionTransition(ServerLevel p_350955_, BlockUtil.FoundRectangle p_350865_, Direction.Axis p_351013_, Vec3 p_351020_, Entity p_350578_, Vec3 p_350266_, float p_350648_, float p_350338_,
		...
		Vec3 vec32 = ModPortalShape.findCollisionFreePosition(vec31, p_350955_, p_350578_, entitydimensions);
