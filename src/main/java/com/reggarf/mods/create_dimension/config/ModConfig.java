...
public class ModConfig {
    ...
    public static class Common {
        ...
        public final ForgeConfigSpec.ConfigValue<String> DIMENSION_BIOME;
        public final ForgeConfigSpec.BooleanValue GENERATE_LAKES;
        public final ForgeConfigSpec.BooleanValue GENERATE_FEATURES;
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> FLAT_LAYERS;

        // Individual Layer Heights
        public final ForgeConfigSpec.IntValue BEDROCK_HEIGHT;
        public final ForgeConfigSpec.IntValue END_STONE_HEIGHT;
        public final ForgeConfigSpec.IntValue NETHERRACK_HEIGHT;
        public final ForgeConfigSpec.IntValue DEEPSLATE_HEIGHT;
        public final ForgeConfigSpec.IntValue STONE_HEIGHT;
        public final ForgeConfigSpec.IntValue ANDESITE_HEIGHT;
        public final ForgeConfigSpec.IntValue DIRT_HEIGHT;
        public final ForgeConfigSpec.IntValue GRASS_BLOCK_HEIGHT;

        // Ore Feature Configs
        public final ForgeConfigSpec.DoubleValue CHUNK_SPAWN_CHANCE;
        public final ForgeConfigSpec.DoubleValue GLOBAL_ORE_MULTIPLIER;
        public final ForgeConfigSpec.DoubleValue GLOBAL_VEIN_SIZE_MULTIPLIER;

        // Layer Ore Boundaries
        public final ForgeConfigSpec.IntValue END_MIN_Y;
        public final ForgeConfigSpec.IntValue END_MAX_Y;
        public final ForgeConfigSpec.IntValue NETHER_MIN_Y;
        public final ForgeConfigSpec.IntValue NETHER_MAX_Y;
        public final ForgeConfigSpec.IntValue DEEPSLATE_MIN_Y;
        public final ForgeConfigSpec.IntValue DEEPSLATE_MAX_Y;
        public final ForgeConfigSpec.IntValue STONE_MIN_Y;
        public final ForgeConfigSpec.IntValue STONE_MAX_Y;
