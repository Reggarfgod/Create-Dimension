...
public class CreatedimensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("create_dimension:steamworks_realm_portal"), poiType);
	...
	public CreatedimensionTeleporter(ServerLevel level) {
		this.level = level;
	}
